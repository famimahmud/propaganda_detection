...
G.add_edge(ROOT,"Not Persuasion")
...
def evaluate_h(pred_fpath, gold_fpath):
    ...
    with multi_labeled(gold, pred, G) as (gold_, pred_, graph_):
        return _h_precision_score(gold_, pred_, graph_), _h_recall_score(gold_, pred_, graph_), _h_fbeta_score(gold_,
                                                                                                               pred_,
                                                                                                               graph_)
...
def validate_files(pred_files, gold_files):
    if not check_format(pred_file):
        print("Bad format for pred file:",pred_file)
